...
const Senva = (new (function() {
  ...
  /**
    ...
    * @param {boolean} [debug] Display the proram's output and the memory when an error occurs
    */
  this.exec = (script, strict, timeout, disableBackMemory, debug) => {
      ...
      if(isLetter) {
        ...
        switch(char) {
          ...
          case '#':
            ...
            started += (getInstant() - prompt_start);
        ...
        if(timeout && getInstant() > started + timeout)
